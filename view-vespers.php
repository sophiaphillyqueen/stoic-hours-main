...
$yetgo = true;
if ( $yetgo ) { $yegto = stoic_hour_cycle_res(realpath(__DIR__ . '/enchiridion.xml'),2017,5,26,array()); }
...
$yetgo = true;
if ( $yetgo ) { $yegto = stoic_hour_cycle_xres('poetry-main-cycle',2017,4,22,array('fixcycle'=>3)); }
